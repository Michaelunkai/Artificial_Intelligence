    ...
    def load_games(self):
        if os.path.exists('games_data.json'):
            ...
            self.all_games = [
                ...
                "singularity", "farcryprimal", "YOUR_CLIENT_SECRET_HERE", "YOUR_CLIENT_SECRET_HEREd",
                "YOUR_CLIENT_SECRET_HEREunishments", "theascent", "ancestorshumankind", "bumsimulator",
                ...
                "YOUR_CLIENT_SECRET_HEREon", "greedfall", "eiyudenchromicle", "crisiscorefinalfantasy7",
